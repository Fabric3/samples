...
/**
 * A pair of {@link PriceLadder}s.
 */
public class PriceLadderPair {
    private final PriceLadder bidLadder;
    private final PriceLadder askLadder;

    public PriceLadderPair(PriceLadder bidLadder, PriceLadder askLadder) {
